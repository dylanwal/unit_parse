...
testing_func(get_value, test_get_value)
...
testing_func(split_on_powers, test_units_with_powers)
...
testing_func(split_on_multiplication_symbol, test_units_with_multi)
...
testing_func(split_on_division_symbol, test_units_with_div)
...
testing_func(merge_split_text, test_merge_split_text)
...
testing_func(frame_shift, test_frame_shift)
...
testing_func(get_unit, test_get_unit)
...
testing_func(get_quantity, test_to_quantity)
